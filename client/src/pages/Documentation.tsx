...
const SECTIONS = [
  ...
  },
  {
    ...
    body: [
      "Connect Stripe and/or PayPal to accept card and digital wallet payments directly at checkout. Funds are deposited to your connected bank account on your chosen payout schedule — EatOut never holds your money longer than necessary.",

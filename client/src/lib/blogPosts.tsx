...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    excerpt: "Branding isn't a logo — it's the sum of every small decision a customer notices. Here's where to actually spend your time.",
    category: "Branding",
    date: "2027-01-12",
    readTime: "6 min read",
    content: [
  ...
  },
  {
    ...
    content: [
      ...
      "Tell the ten people most likely to actually order before you tell the internet. A soft launch to people who already know and trust you surfaces real problems — a confusing checkout step, a missing product photo — while the stakes are still low.",
